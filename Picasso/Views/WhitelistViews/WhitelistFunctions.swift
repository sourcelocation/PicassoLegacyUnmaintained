...
public struct Whitelist {
    ...
    public static func overwriteBlacklist() throws {
        try KFD.overwriteFile(at: "/private/var/db/MobileIdentityData/Rejections.plist", with: Data(base64Encoded: blankplist)!)
    }
    
    public static func overwriteBannedApps() throws {
        try KFD.overwriteFile(at: "/private/var/db/MobileIdentityData/AuthListBannedUpps.plist", with: Data(base64Encoded: blankplist)!)
    }
    
    public static func overwriteCdHashes() throws {
        try KFD.overwriteFile(at: "/private/var/db/MobileIdentityData/AuthListBannedCdHashes.plist", with: Data(base64Encoded: blankplist)!)
    }
