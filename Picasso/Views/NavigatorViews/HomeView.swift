            ...
            List {
                ...
                Section {
                    VStack {
                        ...
                        HStack {
                            Button("kclose and exit") {
                                KFD.kclose()
                                exit(0)
                            }
                            .buttonStyle(TintedButton(color: .red, fullwidth: true))
                            Button {
                                UIApplication.shared.alert(title: NSLocalizedString("Info", comment: "respring info header"), body: NSLocalizedString("Closes KFD, making exploit being able to run again later.", comment: "respring info"))
                            } label: {
                                Image(systemName: "info")
                            }
                            .buttonStyle(TintedButton(material: .systemMaterial, fullwidth: false))
