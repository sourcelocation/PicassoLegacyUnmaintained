...
extension LocationManager
{
    ...
    enum Error: LocalizedError, RecoverableError
    {
        ...
        var failureReason: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("Picasso requires “Always” location permission.", comment: "")
            }
        }
        ...
        var recoverySuggestion: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("Please grant Picasso “Always” location permission in Settings so it can run in the background indefinitely.", comment: "")
            }
        }
