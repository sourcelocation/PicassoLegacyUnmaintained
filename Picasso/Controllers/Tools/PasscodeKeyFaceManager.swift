...
//        KFDFileManager.changeDirectory(to: "/var/mobile/Containers/Data/Application")
...
//        if dir == .passcode {
//            KFDFileManager.changeDirectory(to: "/var/mobile/Library/Caches/")
//            guard let url = try KFDFileManager.contents()
